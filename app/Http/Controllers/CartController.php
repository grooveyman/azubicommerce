...
class CartController extends Controller
{
     ...
     *     path="/carts",
     *     tags={"carts"},
     *     summary="Save cart information",
     *     description="Saves carts to the database",
     *     @OA\Parameter(
     *         name="quantity",
     *         in="query",
     ...
     *             @OA\Property(property="results", type="string", example="Cart created successfully")
     *         )
     *     ),
     *     @OA\Response(
     *         response=422,
    ...
    public function store(Request $request)
    {
        ...
        if ($validateData->fails()) {
            ...
            if ($carts) {
                return response()->json(['status' => 200, 'results' => 'Cart created successfully'], 200);
            } else {
